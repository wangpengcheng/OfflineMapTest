...
frmMain::frmMain(QWidget *parent) : QWidget(parent),
                                    ui(new Ui::frmMain)
{
    ui->setupUi(this);
    //初始化风格
...
void frmMain::InitTabWidget()
{
    ...
    map_control_view_->setSource(QUrl("qrc:/QmlMap/MapControlModel.qml"));
    ...
    speed_chart_widget_->setSource(QUrl("qrc:/QmlMap/MyCharts.qml"));
    //初始化回放布局
